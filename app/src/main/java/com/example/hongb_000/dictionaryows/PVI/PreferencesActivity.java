...
import com.example.hongb_000.dictionaryows.PVI.language.TranslatorBing;
import com.example.hongb_000.dictionaryows.PVI.language.TranslatorGoogle;
import com.example.hongb_000.dictionaryows.R;

/**
 * Class to handle preferences that are saved across sessions of the app. Shows
 * HistoryActivity hierarchy of preferences to the user, organized into sections. These
...
public class PreferencesActivity extends PreferenceActivity implements
  ...
  /**
   * Interface definition for HistoryActivity callback to be invoked when HistoryActivity shared
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
    ...
    if (key.equals(KEY_TRANSLATOR)) {
      ...
      // Save HistoryActivity separate, language-specific character blacklist for this language
  ...
  protected void onResume() {
    ...
    // Set up HistoryActivity listener whenever HistoryActivity key changes
