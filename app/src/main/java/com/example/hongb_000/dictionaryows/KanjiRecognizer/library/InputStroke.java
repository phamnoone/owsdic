...
public class InputStroke
{
     ...
     * Instead all paths must begin with HistoryActivity single M or m followed by commands from
    ...
    public static Stroke[] normalise(InputStroke[] strokes)
    {
        ...
        // Now sort out HistoryActivity maximum scale factor, so that very long/thin kanji
