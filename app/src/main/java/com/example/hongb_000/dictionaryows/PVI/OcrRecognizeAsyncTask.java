...
/**
 * Class to send OCR requests to the OCR engine in HistoryActivity separate thread, send HistoryActivity success/failure message,
...
final class OcrRecognizeAsyncTask extends AsyncTask<Void, Void, Boolean> {
  ...
  protected Boolean doInBackground(Void... arg0) {
    ...
    try {     
      ...
      Log.e("OcrRecognizeAsyncTask", "Caught RuntimeException in request to Tesseract. SettingActivity state to CONTINUOUS_STOPPED.");
      e.printStackTrace();
      try {
        baseApi.clear();
