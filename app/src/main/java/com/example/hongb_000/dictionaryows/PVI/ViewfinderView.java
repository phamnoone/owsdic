...
public final class ViewfinderView extends View {
    ...
    /**
     * Flag to draw word text with HistoryActivity background varying from transparent to opaque.
     */
            ...
            if (bitmapSize.x == previewFrame.width() && bitmapSize.y == previewFrame.height()) {
                ...
                if (DRAW_WORD_BOXES) {
                    ...
                    for (int i = 0; i < wordBoundingBoxes.size(); i++) {
                        // Draw HistoryActivity bounding box around the word
                ...
                if (DRAW_WORD_TEXT) {
                    ...
                    for (int i = 0; i < wordBoundingBoxes.size(); i++) {
                        ...
                        if (!isWordBlank) {
                            // Draw HistoryActivity white background around each word
                            rect = wordBoundingBoxes.get(i);
...
//
//            // Draw HistoryActivity white background for every letter
...
//        }
        ...
        // Draw HistoryActivity two pixel solid border inside the framing rect
        paint.setAlpha(0);
        paint.setStyle(Style.FILL);
