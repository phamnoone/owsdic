...
package com.example.hongb_000.dictionaryows.PVI;
...
import com.example.hongb_000.dictionaryows.PVI.camera.CameraManager;
import com.example.hongb_000.dictionaryows.PVI.camera.ShutterButton;
import com.example.hongb_000.dictionaryows.PVI.language.LanguageCodeHelper;
import com.example.hongb_000.dictionaryows.R;
import com.example.hongb_000.dictionaryows.Search.DisplayKanjiFromCameraActivity;
...
/**
 * This activity opens the camera and does the actual scanning on HistoryActivity background thread. It draws HistoryActivity
 * viewfinder to help the user place the text correctly, shows feedback as the image processing
 * is happening, and then overlays the results when HistoryActivity scan is successful.
 * <p/>
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
     ...
     */
    public static final String DEFAULT_SOURCE_LANGUAGE_CODE = "jpn";

    /**
     * ISO 639-1 language code indicating the default target language for translation.
     */
    public static final String DEFAULT_TARGET_LANGUAGE_CODE = "vi";
    ...
    /**
     * Whether to initially show HistoryActivity looping, real-time OCR display.
     */
    ...
    private int pageSegmentationMode = TessBaseAPI.PSM_AUTO_OSD;
    ...
    void onShutterButtonPressContinuous() {
        ...
        if (lastResult != null) {
            ...
            Toast toast = Toast.makeText(this, "Nhận diện lỗi, Xin vui lòng thử lại" +
                    "", Toast.LENGTH_SHORT);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (holder == null) {
            Log.e(TAG, "surfaceCreated gave us HistoryActivity null surface");
        }
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            // Creating the handler starts the preview, which can also throw HistoryActivity RuntimeException.
...
//    }
    ...
    private void initOcrEngine(File storageRoot, String languageCode, String languageName) {
        ...
        // If we have HistoryActivity language that only runs using Cube, then set the ocrEngineMode to Cube
        ...
        indeterminateDialog.setTitle("Xin vui lòng chờ");
        String ocrEngineModeName = getOcrEngineModeName();
        if (ocrEngineModeName.equals("Both")) {
            indeterminateDialog.setMessage("Khởi tạo Cube và Tesseract OCR engines cho " + languageName + "...");
        } else {
            indeterminateDialog.setMessage("Khởi tạo  " + ocrEngineModeName + " OCR engine cho " + languageName + "...");
        }
    ...
    /**
     * Displays information relating to the result of OCR, and requests HistoryActivity translation if necessary.
     *
     * @param ocrResult Object representing successful OCR results
     * @return True if HistoryActivity non-null result was received for OCR
     */
    boolean handleOcrDecode(final OcrResult ocrResult) {
        lastResult = ocrResult;

        // TestActivity whether the result is null
        if (ocrResult.getText() == null || ocrResult.getText().equals("")) {
            Toast toast = Toast.makeText(this, "Nhận diện lỗi, Xin vui lòng thử lại.", Toast.LENGTH_SHORT);
            toast.setGravity(Gravity.TOP, 0, 0);
            toast.show();
            return false;
        }
        ...
        // touch next activity
        ocrResultTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //tu kanji nhan duoc
                String kanjiText = ocrResult.getText();

                // next sang show nghia kanji
                Intent nextAv = new Intent(CaptureActivity.this, DisplayKanjiFromCameraActivity.class);
                nextAv.putExtra("text", kanjiText);
    ...
    /**
     * Displays information relating to the results of HistoryActivity successful real-time OCR request.
     *
     * @param ocrResult Object representing successful OCR results
     */
    ...
    /**
     * Version of handleOcrContinuousDecode for failed OCR requests. Displays HistoryActivity failure message.
     *
    ...
    /**
     * Given either HistoryActivity Spannable String or HistoryActivity regular String and HistoryActivity token, apply
     ...
     * ForegroundColorSpan(0xFFFF0000));} will return HistoryActivity CharSequence {@code
    ...
    private CharSequence setSpanBetweenTokens(CharSequence text, String token,
        ...
        if (start > -1 && end > -1) {
            // Copy the spannable string to HistoryActivity mutable spannable string
...
//                    toast.show();
    ...
    void setStatusViewForContinuous() {
        viewfinderView.removeResultText();
        if (CONTINUOUS_DISPLAY_METADATA) {
            statusViewBottom.setText("OCR: " + sourceLanguageReadable + " - Vui lòng đợi...");
        }
    }
     ...
     *
     * @param clickable True if the button should accept HistoryActivity click
     */
    ...
    /**
     * Requests autofocus after HistoryActivity 350 ms delay. This delay prevents requesting focus when the user
    ...
    private void requestDelayedAutoFocus() {
        ...
        // the user just wants to take HistoryActivity picture without focusing.
    ...
    /**
     * We want the help screen to be shown automatically the first time HistoryActivity new version of the app is
     * run. The easiest way to do this is to check android:versionCode from the manifest, and compare
     * it to HistoryActivity value stored as HistoryActivity preference.
     */
    ...
    /**
     * Returns HistoryActivity string that represents which OCR engine(s) are currently set to be run.
     *
    ...
    void displayProgressDialog() {
        ...
        String ocrEngineModeName = getOcrEngineModeName();
        if (ocrEngineModeName.equals("Both")) {
            indeterminateDialog.setMessage("Đang phân tích hình ảnh...");
        } else {
            indeterminateDialog.setMessage("Đang phân tích hình ảnh...");
        }
        indeterminateDialog.setCancelable(false);
    ...
    void showErrorMessage(String title, String message) {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Thoát", new FinishListener(this))
                .show();
    }
}
