 ...
 */
package com.example.hongb_000.dictionaryows.PVI.language;
...
public class LanguageCodeHelper {
	...
	/**
	 * Map the given ISO 639-3 language code to HistoryActivity name of HistoryActivity language, for example,
	 * "Spanish"
	 * 
	 * @param context
	...
	/**
   * Map the given ISO 639-1 language code to HistoryActivity name of HistoryActivity language, for example,
   * "Spanish"
	 * 
	 * @param languageCode
